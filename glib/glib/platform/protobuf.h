...
// ::glib::protobuf namespace.
//
// TensorFlow code should use the ::glib::protobuf namespace to
// refer to all protobuf APIs.

#if defined(PLATFORM_GOOGLE)
#include "glib/platform/google/protobuf.h"
#else
#include "glib/platform/default/protobuf.h"
#endif
