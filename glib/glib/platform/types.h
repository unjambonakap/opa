...
#include "glib/platform/google/integral_types.h"
#elif defined(PLATFORM_POSIX) || defined(PLATFORM_POSIX_ANDROID) || \
    defined(PLATFORM_GOOGLE_ANDROID) || defined(PLATFORM_WINDOWS)
#include "glib/platform/default/integral_types.h"
#else
...
// Define glib::string to refer to appropriate platform specific type.
