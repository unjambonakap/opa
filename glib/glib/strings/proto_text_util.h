...
#include "glib/strings/scanner.h"
...
class ProtoTextOutput {
 public:
  ...
  void AppendString(const char field_name[], const string& value) {
    AppendFieldAndValue(
        field_name, StrCat("\"", ::glib::str_util::CEscape(value), "\""));
  }
