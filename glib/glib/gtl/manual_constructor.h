...
#include "glib/platform/mem.h"  // For aligned_malloc/aligned_free
...
#define TF_LIB_GTL_ALIGNED_CHAR_ARRAY(T, Size)                          \
  typename glib::gtl::internal::AlignType<TF_LIB_GTL_ALIGN_OF(T), \
...
#define TF_LIB_GTL_ALIGNED_CHAR_ARRAY(T, Size) \
  glib::gtl::internal::AlignType<Size * sizeof(T)>::result
